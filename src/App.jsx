          ...
          >
            {isLoggedIn ? (
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span
                  style={{ fontSize: 14, fontWeight: 500, color: "#0a2540" }}
                >
                  {userName || "Dr. Smith"}
                </span>
              </div>
        ...
        <div className="mobile-menu">
          {navItems.map((item) => (
            <button
              key={item.path}
              className={
                "mobile-menu-nav-item" + (isActive(item.path) ? " active" : "")
              }
              onClick={() => {
                navigate(item.path);
                setMenuOpen(false);
          ...
          <div className="mobile-menu-auth">
            {isLoggedIn ? (
              ...
              >
                ...
                <span
                  style={{ fontSize: 16, fontWeight: 500, color: "#0a2540" }}
                >
                  {userName || "Dr. Smith"}
                </span>
              </div>
  ...
  return (
    <section
      ...
      style={{
        ...
        alignItems: "center",
        background:
          "linear-gradient(165deg, #f8fafd 0%, #eef3fb 40%, #e3ecf8 100%)",
        position: "relative",
        overflow: "hidden",
      }}
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(26,115,232,0.08) 0%, transparent 70%)",
        }}
      />
      <div
        style={{
      ...
      >
        <div className="hero-content" style={{ maxWidth: 680 }}>
          ...
          >
            ...
            <span style={{ fontStyle: "italic", color: "#1a73e8" }}>
              Peptides
            </span>
            <br />
...
function ProductDetailPage() {
  ...
  return (
    <section
      ...
      style={{ padding: "120px 32px 80px", maxWidth: 1280, margin: "0 auto" }}
    >
      <button
        onClick={() => navigate("/catalog")}
        style={{
      ...
      >
        ...
        <div>
          ...
          >
            <span>
              Purity:{" "}
              <strong style={{ color: "#0a2540" }}>{product.purity}</strong>
            </span>
            <span>•</span>
            <span>
              MW:{" "}
            ...
            <span>
              Storage:{" "}
              <strong style={{ color: "#0a2540" }}>{product.storage}</strong>
            </span>
          </div>
    ...
    >
      <div style={{ marginBottom: 48 }}>
        ...
        <p style={{ fontSize: 16, color: "#718096", margin: 0 }}>
          Browse our full range of pharmaceutical-grade peptides with COA
          documentation.
        </p>
      </div>
          ...
          {[
            {
              icon: "🔬",
              title: "99%+ Purity",
              desc: "Every batch verified via HPLC and Mass Spectrometry by independent, CLIA-certified laboratories.",
            },
            {
              icon: "📋",
              title: "Full COA Access",
              desc: "Certificate of Analysis with complete analytical data available for every product before purchase.",
            },
            {
              icon: "🏭",
              title: "GMP Manufacturing",
              desc: "Produced in FDA-registered, cGMP-compliant facilities in the United States.",
            },
            {
              icon: "🚚",
              title: "Cold Chain Shipping",
              desc: "Temperature-controlled packaging ensures peptide integrity from warehouse to your practice.",
            },
          ].map((f, i) => (
            <div
              key={i}
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          >
            {tab === "login" ? "Welcome Back" : "Physician Registration"}
          </h2>
          <p style={{ fontSize: 14, color: "#718096", margin: 0 }}>
            {tab === "login"
              ? "Sign in to your account"
              : "Create your verified physician account"}
          </p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {tab === "register" && (
            <>
              <input
                placeholder="NPI Number (National Provider Identifier)"
                value={form.npi}
              ...
              <select
                ...
                style={{
                  ...inputStyle,
                  color: form.specialty ? "#0a2540" : "#a0aec0",
                }}
              >
...
function ChatBot({ open, onOpen, onClose }) {
  ...
  const getResponse = (msg) => {
    ...
    if (lower.includes("semaglutide") || lower.includes("glp"))
      return CHAT_RESPONSES.semaglutide;
    if (
      lower.includes("stor") ||
      lower.includes("keep") ||
      lower.includes("temperature")
    )
      return CHAT_RESPONSES.storage;
    if (
  ...
  const send = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { from: "bot", text: getResponse(userMsg) },
      ]);
    }, 800);
  };
          ...
          >
            <div
              style={{
                ...
                lineHeight: 1.55,
                boxShadow:
                  msg.from === "bot" ? "0 1px 4px rgba(0,0,0,0.06)" : "none",
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Pharmaceutical-grade peptides for licensed healthcare
              professionals. GMP-certified, third-party tested, USA
              manufactured.
            </p>
          </div>
          ...
          {[
            ...
            {
              title: "Company",
              links: ["About Us", "Quality Standards", "Contact", "Careers"],
            },
          ].map((col, i) => (
            <div key={i}>
              <div
...
function AboutPage() {
  return (
    <section
      ...
      style={{ padding: "120px 32px 80px", maxWidth: 800, margin: "0 auto" }}
    >
      <h2
        style={{
          fontFamily: "'Instrument Serif', serif",
      ...
      >
        PeptidePro was founded with a singular mission: to provide physicians
        with the highest-quality, independently verified peptides available in
        the United States.
      </p>
      <p
        style={{
      ...
      >
        Every product in our catalog is manufactured in FDA-registered,
        cGMP-compliant facilities and undergoes rigorous third-party testing
        including HPLC purity analysis, mass spectrometry, endotoxin screening,
        and sterility verification.
      </p>
      <p style={{ fontSize: 17, color: "#4a5568", lineHeight: 1.75 }}>
        We believe that healthcare professionals deserve complete transparency.
        That's why we provide batch-specific Certificates of Analysis for every
        product and maintain full traceability from synthesis to delivery.
      </p>
    </section>
  );
}
...
function COAPage() {
  ...
  return (
    <section
      ...
      style={{ padding: "120px 32px 80px", maxWidth: 1000, margin: "0 auto" }}
    >
      <h2
        style={{
          fontFamily: "'Instrument Serif', serif",
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ padding: "80px 32px", background: "#f8fafd" }}
      >
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div
